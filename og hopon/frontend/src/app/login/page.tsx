    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 to-green-500">
      <div className="card p-8 max-w-md w-full mx-4">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">🏀 HopOn</h1>
          <p className="text-gray-600">Find & Join Pickup Sports Games</p>
        </div>
        ...
        {error && (
          <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
            <p className="text-red-800 text-sm">
              ...
              {error === 'missing_tokens' && 'Missing authentication tokens.'}
            </p>
          </div>
        )}
